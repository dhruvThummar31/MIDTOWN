...
import PSell from "../assets/PSell.jpg";
  ...
  return (
    <div className="pt-24 lg:pt-28 md:pt-28 w-full font-['Founders_Grotesk']">
      ...
      <div className="bsri-img-div flex justify-center mb-[10vh]">
        <img src={PSell} alt="" width={900} className="bsri-img  rounded-2xl" />
      </div>
      ...
      <div className="relative py-12 px-6 lg:px-24">
        ...
        <div className="relative">
          ...
          Elevate your selling experience with
            <span className="text-[#004D43]"> MIDTOWN</span> -where expertise meets dedication, ensuring your property reaches its fullest potential in the market.
          </p>
        ...
        <div className="mt-16">
          ...
          With respect to real estate properties, we host a huge volume of customers who are keen on buying properties - residential and commercial - in different parts of the city. From the selling perspective, our company is the connecting tissue that binds the veins of real estate; in this case the buyers. Here's why you need to contact us:
          </p>
