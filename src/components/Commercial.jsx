...
import { commercialProjects } from './ProjectsData';
...
function Commercial() {
  ...
  return (
    <div  className="font-['Founders_Grotesk']">
      <motion.div
        className="rcpi-main pt-[32vh] px-10 text-[6vw] leading-[6vw] tracking-tight rounded-xl "
      ...
      >
        ...
        <motion.p
          className="rcpi-mini-para text-center font-light tracking-normal uppercase text-[5.6vw]"
          variants={textVariants}
        >
          of our standout
        </motion.p>
